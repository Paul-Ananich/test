...
app.get('/message',  function(request, response) {
    ...
    connection.connect(function(err) {
        if (err) throw err;
        connection.query('SELECT message.date, message.source_url, account.name, essence.essence\n' +
            'FROM user\n' +
...
app.listen(port, () => console.log(`Example app listening at http://localhost:${port}/message`));
